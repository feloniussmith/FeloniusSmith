...
const NavGuitar = () => {
  return (
    <>
      ...
      <NavLink to='/calendar' className={styles.dotButton} style={{top: '99px', left: '8.3%'}} activeClassName='active'><img src={navCalendar} alt='felonius-calendar' /></NavLink>
      <NavLink to='/music' className={styles.dotButton} style={{top: '165px', left: '9.4%'}} activeClassName='active'><img src={navMusic} alt='felonius-music' /></NavLink>
      ...
      <NavLink to='/' className={styles.dotButton} style={{top: '725px', left: '18%'}} activeClassName='active'><img src={navHome} alt='felonius-home' /></NavLink>
    </>
  )
}
